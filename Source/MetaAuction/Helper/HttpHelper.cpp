 ...
 */
void FHttpHelper::Request(const FString& InAddUrl, const EHttpRequestType InType, const FCompleteCallback& InFunc, const FString& InBody) const
{
 ...
 */
FString FHttpHelper::JsonToString(const TSharedRef<FJsonObject>& InObj) const
{
	FString stringBody;
