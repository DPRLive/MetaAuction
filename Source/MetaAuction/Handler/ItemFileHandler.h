...
public:
	...
	void RequestImg(const FCallbackOneParam<UTexture2DDynamic*>& InFunc, uint32 InItemId, uint8 InImgIdx) const;
private:
	// glb 파일을 웹서버에 요청한다.
	void _RequestGlbToWeb(const FCallbackRefOneParam<FString>& InFunc, uint32 InItemId) const;
